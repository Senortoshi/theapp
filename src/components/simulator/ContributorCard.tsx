    ...
    return (
      <div
        ...
        style={{
          ...
          borderLeft: isRising ? "2px solid var(--green)" : "2px solid transparent",
          boxShadow: isRising ? "0 0 0 1px rgba(0,245,160,0.2), 0 0 24px var(--green-dim)" : isDecaying ? "0 0 0 1px rgba(255,59,92,0.15)" : undefined,
      ...
      >
        ...
        <div className="flex-1 min-w-0 flex flex-col justify-center gap-1">
          <div className="flex items-center justify-between gap-2">
            <span className="truncate font-semibold" style={{ fontSize: 13, color: "var(--text-1)", fontFamily: "var(--font-ui)" }}>
              {contributor.username}
            </span>
            <StatusBadge status={status} />
          </div>
          <ShareBar sharePct={sharePct} />
          <div className="flex items-center justify-between gap-2">
